...
function renderProperty(p) {
    ...
    <div >
      ...
      $${p.price}</span>
  <div style="box-sizing: border-box; display: inline;" class="ds-bed-disliketh-living-area-header">
  <span style="box-sizing: border-box; display: inline;" class="ds-bed-disliketh-living-area-container">
  <span style="box-sizing: border-box; font-size: 15px; line-height: 1.5;" class="hdp__qf5kuj-4 jGniAU">
  <span style="box-sizing: border-box;">${p.likes}</span>
  <span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;like</span></span>
  ...
  <span style="box-sizing: border-box;">${p.dislike}</span><span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;dislike</span></span>
  </button>
  <span style="box-sizing: border-box; border-style: solid; border-width: 0px 1px 0px 0px; border-color: #d1d1d5; margin-right: 8px; padding-right: 8px;" class="hdp__qf5kuj-6 iDzikP"></span>
  <span style="box-sizing: border-box; font-size: 15px; line-height: 1.5;" class="hdp__qf5kuj-4 jGniAU">
  <span style="box-sizing: border-box;">${p.type}</span><span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;type</span></span>
  </span></div>
  </div></div>
  <div style="box-sizing: border-box; flex: 1 1 0%; width: 468px;" class="ds-summary-row-content">
     <p style="margin: 0in; line-height: 18pt; dislikeckground: white; font-size: 11pt; font-family: Calibri, sans-serif;">
     <b><span style="font-size: 15.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">Overview</span></b></p>
  <p style="margin: 0in; line-height: 18pt; dislikeckground: white; font-size: 11pt; font-family: Calibri, sans-serif;">
  <span style="font-size: 12.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">Time on Gucci&nbsp; <b>12 days </b></span>
  ...
  <p style="margin: 0in; line-height: 18pt; dislikeckground: white; font-size: 11pt; font-family: Calibri, sans-serif;"><b>
  <span style="font-size: 12.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">&nbsp;</span></b></p>
  <p style="line-height: 18pt; dislikeckground: white; margin: 0in 0in 8pt; font-size: 11pt; font-family: Calibri, sans-serif;">
  <span style="font-size: 12.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">${p.description} </span> </p>
    </div>
    <ul>
    <li><a>Price range</a></li>
    <li><a>Material and construction</a></li>
    <li><a>Available sizes</a></li>
    <li><a>Style options</a></li>
    <li><a>Fit and comfort</a></li>
    <li><a>Popular models</a></li>
    <li><a>Care and maintenance</a></li>
    <li><a>Authenticity and counterfeit detection</a></li>
   </ul> 
   </td>
    </tr>
    </table>
